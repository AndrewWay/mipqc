function output=rotate_around(image, pointY, pointX, angle, varargin)
% ROTATEAROUND rotates an image.
%   ROTATED=ROTATE_AROUND(IMAGE, POINTY, POINTX, ANGLE) rotates IMAGE around
%   the point [POINTY, POINTX] by ANGLE degrees. To rotate the image
%   clockwise, specify a negative value for ANGLE.
%
%   ROTATED=ROTATE_AROUND(IMAGE, POINTY, POINTX, ANGLE, METHOD) rotates the
...
%   Example
%   -------
%       imshow(rotate_around(imread('eight.tif'), 1, 1, 10));
%
