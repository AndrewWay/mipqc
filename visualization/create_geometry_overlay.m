...
I_overlayed=insertText(I_overlayed,[xInts(1,2) yInts(1,2)],ang2,'FontSize',font_size,...
    'BoxColor','black','TextColor','white');
I_overlayed=insertText(I_overlayed,[xInts(2,1) yInts(2,1)],ang3,'FontSize',font_size,...
    'BoxColor','black','TextColor','white');
I_overlayed=insertText(I_overlayed,[xInts(2,2) yInts(2,2)],ang4,'FontSize',font_size,...
    'BoxColor','black','TextColor','white');
...
I_overlayed=insertText(I_overlayed,[l1_l_x l1_l_y],num2str(line1_length,'%2.0f px'),'FontSize',font_size,...
    'BoxColor','black','TextColor','white');
I_overlayed=insertText(I_overlayed,[l2_l_x l2_l_y],num2str(line2_length,'%2.0f px'),'FontSize',font_size,...
    'BoxColor','black','TextColor','white');
I_overlayed=insertText(I_overlayed,[l3_l_x l3_l_y],num2str(line3_length,'%2.0f px'),'FontSize',font_size,...
    'BoxColor','black','TextColor','white');
I_overlayed=insertText(I_overlayed,[l4_l_x l4_l_y],num2str(line4_length,'%2.0f px'),'FontSize',font_size,...
    'BoxColor','black','TextColor','white');
